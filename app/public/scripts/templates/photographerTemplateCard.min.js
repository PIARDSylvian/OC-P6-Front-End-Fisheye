class PhotographerTemplateCard{constructor(r){this._photographer=r}getRender(){var r=document.createElement("article");return r.classList.add("photographer"),r.innerHTML=`
